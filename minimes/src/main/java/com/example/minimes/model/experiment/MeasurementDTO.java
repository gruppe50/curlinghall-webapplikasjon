...
public class MeasurementDTO {
    ...
    public MeasurementDTO(LocalDateTime time, double bigLaneIceTemp, double smallLaneIceTemp, double hallTemp, double humidity, TestDates testDates, double glycolTemp) {
        this.time = time;
